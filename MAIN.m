...
[up,vp] = applyBC(data,p); % MOVIMIENTOS (todo 0) Y DIRECCIONES RESTRINGIDAS {[1](1,2);[3](5,6)}

% Apply point loads
f = pointLoads(data,Td,f,F);

% Solve system
[u.bici,r.bici] = solveSystem(data,K,f,up,vp);


% Compute stress
sig.bici = stressFunction(data,x,Tn,m,Tm,Td,u.bici);
...
plot2DBars(data,x,Tn,u.bici,sig.bici,scale,units);
